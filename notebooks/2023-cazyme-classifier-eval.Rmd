...
```{r classTaxSpecSave2, echo=FALSE}
# save plots
...
```{r classTaxSensPerClassSave, echo=FALSE}
# save plots
...
```{r classTaxPrecSave2, echo=FALSE}
# save plots
...
pdf(file = "../report/cazy_family_classification/poor_performing_fams/poorFamSensGH.pdf", width = 8, height = 8)
p.gh.poor.pops
dev.off()
```
...
pdf(file = "../report/cazy_family_classification/poor_performing_fams/poorFamSensGT.pdf", width = 8, height = 6.2)
p.gt.poor.pops
dev.off()
```
...
pdf(file = "../report/cazy_family_classification/poor_performing_fams/poorFamSensPL.pdf", width = 8, height = 3.5)
p.pl.poor.pops
dev.off()
```
...
pdf(file = "../report/cazy_family_classification/poor_performing_fams/poorFamSensCbm.pdf", width = 8, height = 8)
p.cbm.poor.pops
dev.off()
```
